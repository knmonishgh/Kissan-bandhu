...
public class sellerlogin extends AppCompatActivity {
    ...
    private EditText phone, otp, name, gst;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRef = mDatabase.getReference("seller_login");
        ...
        btnverify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(TextUtils.isEmpty(otp.getText().toString())){
                    Toast.makeText(sellerlogin.this, "Please enter OTP", Toast.LENGTH_SHORT).show();
                }
                else {
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks
        ...
        public void onVerificationFailed(@NonNull FirebaseException e) {
            Toast.makeText(sellerlogin.this, "Wrong Number", Toast.LENGTH_SHORT).show();
        }
        ...
        public void onCodeSent(@NonNull String s,
            ...
            verificationid = s;
            Toast.makeText(sellerlogin.this, "OTP Sent", Toast.LENGTH_SHORT).show();
        }
    };
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(sellerlogin.this, "Wrong OTP", Toast.LENGTH_SHORT).show();
                            otp.setText("");
                        }
